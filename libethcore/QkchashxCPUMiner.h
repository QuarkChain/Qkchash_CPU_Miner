...
namespace dev
{
	namespace eth
	{
		...
		class QkchashxCPUMiner : public GenericMiner<EthashProofOfWork>, Worker
		{
		public:
			QkchashxCPUMiner(GenericMiner<EthashProofOfWork>::ConstructionInfo const& _ci);
			~QkchashxCPUMiner();
